import {
  ...
  getPublicFolderFileDownloadUrl,
  getFileShareLinks,
  getFolderShareLinks
...
// ==================== PUBLIC FOLDER FILE DOWNLOAD ====================

export const publicFolderFileDownloadController = asyncHandler(async (req, res) => {
    const data =
      await getPublicFolderFileDownloadUrl({
        token:
          req.params.token,
...
export const getFileShareLinksController = asyncHandler(async (req, res) => {
    const data =
      await getFileShareLinks({
        fileId: req.params.fileId,
        userId: req.user.id,
      });
...
export const getFolderShareLinksController = asyncHandler(async (req, res) => {
    const data =
      await getFolderShareLinks({
        folderId: req.params.folderId,
        userId: req.user.id,
      });
